...
@section('content')
<section class="py-8 py-md-12 mt-5 bg-white d-flex align-items-center"> {{-- Menyesuaikan background dan alignment --}}
    <div class="container">
        <div class="row align-items-center justify-content-center g-5"> {{-- g-5 untuk gap yang lebih besar --}}
            ...
            <div class="col-12 col-md-6 order-md-2 order-1 text-center text-md-start"> {{-- Order agar info di atas gambar di mobile --}}
                ...
                <div class="contact-info text-dark mb-4">
                    ...
                    <p class="fs-5 mb-2">
                        <i class="bi bi-envelope-fill me-2 text-danger"></i> Email: <a href="mailto:pinjamoto@cs.com" class="text-decoration-none text-dark hover-effect">pinjamoto@cs.com</a>
                    </p>
                    <p class="fs-5 mb-2">
                    ...
                    <p class="fs-5 mt-4">
                        <i class="bi bi-geo-alt-fill me-2 text-danger"></i> Alamat: Jl. Maju Mundur No. 17300, Kota Koti
                    </p>
                </div>
